...
// [END declare_auth_listener]
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        Logg.d(TAG, "signInWithCredential:onComplete:" + task.isSuccessful());
    ...
    private void updateUI(FirebaseUser user) {
        hideProgressDialog();
        if (user != null) {
            //Change to user login page
            Intent intent = new Intent(UserLoginActivity.this, AdminMainActivity.class);
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        ...
        // be available.
        Logg.d(TAG, "onConnectionFailed:" + connectionResult);
    ...
    public void findViews() {
        ...
        links(R.id.sign_in_button).setOnClickListener(this);
    }
